...
@section('content')
    <section class="min-h-screen flex items-center">
        <div class="max-w-[1200px] mx-auto px-6 lg:px-12 w-full py-28 lg:py-32">
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-24 lg:gap-16">
                <div class="flex flex-col justify-center">
                    <div class="section-label fade-in">Creación de contenido</div>

                    <h1 class="heading-xl mb-14 lg:mb-6 fade-in fade-in-delay-1">
                        Contenido que <br>
                        <span class="font-light">conecta</span>
                    </h1>

                    <p class="text-body-lg max-w-md mb-20 lg:mb-10 fade-in fade-in-delay-2">
                        Cubrimos eventos con fotografía y video, creamos sesiones personalizadas y contenido para marcas.
                    </p>

                    <div class="flex flex-wrap gap-6 lg:gap-4 fade-in fade-in-delay-3">
    ...
    <section class="py-36 lg:py-32 bg-white">
        <div class="max-w-[1200px] mx-auto px-6 lg:px-12 text-center">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-semibold text-[#0A0A0A] mb-12 lg:mb-6">
                ¿Listo para crear <br>contenido visual <span class="font-light">impactante</span>?
            </h2>
            <p class="text-sm text-[#666666] max-w-md mx-auto mb-16 lg:mb-10">
